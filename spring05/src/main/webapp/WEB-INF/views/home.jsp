...
<script>
	$(function() {
		...
		$("#btnData").click(function(){
			...
			$.ajax({
				type: "post",
				url: "${path}/members/userid_check.do",
				data: param,
...
body .container .half.bg {
	background-image: url("${path}/images/pro_photo.png");
			...
			<div class="content">
				<div class="signin-cont cont">
					<form name="form1" method="post">
						<input name="userid" id="userids" required="required"
							placeholder="Your ID"> <input type="password"
						...
						<td colspan="2" align="center"><input type="button"
							...
							<button id="popPw" type="button">비밀번호 찾기</button> <c:if
								...
								<div style="color: blue;">로그아웃 처리 되었습니다.</div>
							</c:if></td>
					</form>
				</div>
				<div class="signup-cont cont">
					<form method="post" action="${path}/members/join.do">
						...
						<button type="button" id="btnData" style="float: right;" class="btn btn-default">중복확인</button>
						<div id="panal"></div>
						<input type="password" name="passwd" id="passwd" class="inpt" oninput="passwdCheck()" required="required" placeholder="비밀번호">
						<div id="passwdCheck" style="font-size: 0.8em;"></div>
						<input type="text" name="name" id="name" class="inpt" oninput="nameCheck()" required="required" placeholder="이름">
